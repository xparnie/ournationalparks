    ...
    return (
      <div className="homepage">
        <div className="homepage-carousel">
          {collections
            .filter(collection => collection.title === 'NationalParks')
        ...
        <div className="container">
          <div className="heroBlock">
            <div className="heroBlock-media">
              <img
                ...
                alt="Sunset over the mountains in Flagstaff, AZ"
              />
            </div>
            <div className="heroBlock-content">
              <h1 className="heroBlock-content-title">Exploring America</h1>
              <p className="heroBlock-content-body">
                I've visited 15/58 National Parks, so far
              </p>
          ...
          <div className="heroBlock">
            <div className="heroBlock-content">
              <h1 className="heroBlock-content-title">
            ...
            <div className="heroBlock-media">
              <img
                src="../images/between-the-joshua-trees.jpg"
                alt="Moon between branches of Joshua Tree"
              />
            </div>
          </div>
        </div>
