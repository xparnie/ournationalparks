...
const ContactPage = () => {
  ...
  const handleSumbit = e => {
    ...
    if (nameError.length || emailError.length || phoneError.length) {
      return alert('Please fill out form correctly')
    }

    firebaseConfig
      .database()
      .ref('our-national-parks')
      .set({
        name: name,
        email: email,
        phone: phone,
  ...
  const validate = e => {
    ...
    switch (name) {
      ...
      case 'email':
        ...
        check = !validEmailRegex.test(value)
      ...
      case 'phone':
        ...
        check = !validPhoneRegex.test(value)
          ? 'Phone must be in valid form 123-123-1213'
          : ''
        !check.length
      ...
      <div className="contact">
        <form id="contactForm" onSubmit={handleSumbit}>
          ...
          <div className="contactForm-field">
            <label className="contactForm-field-label">
              Name <span>*</span>
            </label>
            <input
              ...
              required
            />
            <span className="name-input-error error">
          ...
          <div className="contactForm-field">
            ...
            <input
              ...
              required
            />
            <span className="email-input-error error">
              Email must be in valid form
            </span>
          </div>
          <div className="contactForm-field">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <span className="phone-input-error error">
              Phone must be in valid form 123-123-1213
            </span>
          </div>
          <div className="contactForm-field">
          ...
          <div className="contactForm-field">
            <div className="submit-content">
              <button className="submit-content-button" type="submit" disabled>
                Submit
              </button>
            </div>
            <div className="contactForm-field-success">
              Your message has been sent, Cheers!
            </div>
          </div>
        </form>
      </div>
